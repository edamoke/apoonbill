...
export default async function LoyaltyPage() {
  try {
    ...
    console.error("Critical error in LoyaltyPage:", error)
    return (
      <div className="p-6">
        <h1 className="text-red-500 font-bold">Error loading loyalty data</h1>
        <p className="text-sm text-muted-foreground">Please check console for details or ensure database migrations are applied.</p>
      </div>
    )
  }
}
